...
parser.add_argument('--data', type=str, default='./datasets/rain800/', help='location of the data')
...
parser.add_argument('--learning_rate', type=float, default=2e-3, help='init learning rate')
parser.add_argument('--save', type=str, default='EXP', help='experiment name')
parser.add_argument('--grad_clip', type=float, default=5, help='gradient clipping')
parser.add_argument('--patch_size', type=int, default=64, help='patch size')
parser.add_argument('--gpu', type=str, default='3', help='gpu device ids')
parser.add_argument('--ckt_path', type=str, default='search-EXP-20201112-155305/last_weights.pt', help='checkpoint path of search')
